...
const SignupForm = ({ onSignUp }) => {
  ...
  return (
    <div className="max-w-md mx-auto p-6 bg-white rounded-md shadow-md text-foreground">
      ...
      <form onSubmit={handleSignUp}>
        <div className="mb-4">
          ...
          <input
            type="email"
            id="email"
            className="w-full px-3 py-2 rounded border focus:ring focus:ring-blue-300 text-foreground"
            value={email}
